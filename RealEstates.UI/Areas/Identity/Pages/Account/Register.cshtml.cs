...
namespace RealEstates.UI.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, RolesDict.Użytkownik);
                    ...
                    await _email.SendAsync("Potwierdź e-mail",
